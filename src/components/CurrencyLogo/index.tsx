...
const getTokenLogoURL = (address: string) =>
  // https://raw.githubusercontent.com/emmanbol/swap_lions/main/images/coins/lion_logo.png
  `https://raw.githubusercontent.com/emmanbol/swap_lions/main/images/coins/${address}.png`
...
export default function CurrencyLogo({
  ...
  if (currency === ETHER) {
    return <StyledBnbLogo src="/images/coins/TARA.png" size={size} style={style} />
  }
